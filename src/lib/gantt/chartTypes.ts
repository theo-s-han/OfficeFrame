...
export const ganttChartTypes: GanttChartTypeConfig[] = [
  ...
  },
  {
    ...
    name: "마일스톤형",
    shortName: "마일스톤",
    description: "승인, 릴리즈, 마감 같은 주요 시점을 문서형 흐름으로 정리합니다.",
    editorTitle: "마일스톤 입력",
    editorHelp:
      "이름, 날짜, 섹션, 이전 단계만 정하면 주요 시점 흐름을 쉽게 만들 수 있습니다.",
    previewTitle: "마일스톤 흐름",
    previewHelp: "섹션별 주요 시점을 Timeline preview 1개로 깔끔하게 보여줍니다.",
    defaultViewMode: "Week",
    taskNameLabel: "Name",
    startLabel: "Date",
    endLabel: "End",
